...
const About: React.FC = () => {
  return (
    <Section id="about" className="relative my-20">
      <div className="absolute -top-10 md:-top-20 left-0 text-[18vw] md:text-[12rem] font-serif font-bold text-gray-200 dark:text-white/10 select-none -z-10 leading-none overflow-hidden w-full whitespace-nowrap">
        PERSONAL
      </div>
        ...
        <div className="lg:col-span-5 space-y-10 relative z-10">
          <div>
            ...
            <p className="text-sm sm:text-base md:text-lg text-gray-600 dark:text-gray-400 font-light leading-relaxed">
              Off-screen? You'll find me harmonizing as a Soprano 🎶, getting lost
              in fantasy worlds 📚, or hunting for the perfect White Mocha ☕.
            </p>
          </div>
          ...
          <div className="bg-yellow-100 dark:bg-yellow-500/10 border-l-4 border-yellow-400 p-4 sm:p-6 rounded-r-lg sm:rounded-r-xl relative shadow-sm transform hover:scale-[1.02] transition-transform">
            ...
            <h3 className="font-bold text-base sm:text-lg mb-2 text-gray-800 dark:text-yellow-200">
              Hot Take 🌶️
            </h3>
            <p className="italic text-gray-700 dark:text-gray-300 font-serif text-sm sm:text-base md:text-lg">
              "While I respect the rigor of algorithms, the real spark for me is
              turning ideas into polished, inclusive, aesthetically thoughtful
              experiences. I'd much rather pour that energy into building
              something delightful and accessible than spend another minute
              inverting binary trees on a whiteboard. ✨"
            </p>
            <div className="mt-3 sm:mt-4 flex flex-wrap gap-1.5 sm:gap-2">
              <span className="px-1.5 sm:px-2 py-0.5 sm:py-1 bg-white/50 dark:bg-black/20 rounded text-[10px] sm:text-xs font-mono text-gray-600 dark:text-gray-400">
                #BuilderAtHeart
              </span>
            </div>
          </div>
          ...
          <div className="relative">
            <Reveal>
              <h3 className="font-hand text-3xl md:text-4xl text-gray-400 mb-4 inline-block animate-subtle-float">
                Currently Exploring...
              </h3>
            </Reveal>
            ...
            <div className="flex flex-wrap gap-3">
              {[
                ...
                <span
                  key={topic}
                  className="px-4 py-2 border border-gray-200 dark:border-gray-700 rounded-full text-sm font-medium hover:bg-light-accent hover:text-white dark:hover:bg-dark-accent dark:hover:text-black transition-colors cursor-default"
                >
                  {topic}
                </span>
              ))}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 lg:gap-12 items-start justify-items-center">
            ...
            <div className="relative transform -rotate-1 lg:rotate-6 hover:rotate-0 transition-all duration-500 w-full max-w-xs lg:w-52 bg-[#fcfcfc] p-4 shadow-md font-mono text-xs text-gray-600 border-t-4 border-gray-200">
              <div className="text-center mb-4 border-b border-dashed border-gray-300 pb-2">
                ...
                <Reveal delay={200}>
                  <span className="font-bold block text-sm uppercase">
                    Daily Fuel
                  </span>
                </Reveal>
              ...
              <div className="absolute -bottom-1 left-0 w-full h-2 bg-transparent bg-[length:10px_10px] bg-[radial-gradient(circle,transparent_50%,#fcfcfc_50%)] rotate-180" />
            </div>

            {/* Camera Icon (acts like a spacer / accent, no overlap) */}
            <div className="w-full flex justify-center sm:justify-start lg:justify-center sm:col-span-2 lg:col-span-1">
              <div className="text-gray-800 dark:text-gray-200 transform rotate-12 hover:rotate-45 transition-transform">
            ...
            <div className="relative transform -rotate-2 lg:rotate-3 hover:rotate-0 hover:scale-105 transition-all duration-500 w-full max-w-[280px] bg-gray-900 text-white p-4 rounded-2xl shadow-2xl border border-gray-700">
              ...
              <div className="absolute -right-2 -top-2 bg-green-500 text-black text-[10px] font-bold px-2 py-1 rounded-full">
                NOW PLAYING
              </div>
            </div>

            {/* Manifesto Terminal */}
            <div className="transform -rotate-2 hover:rotate-0 transition-transform duration-300 bg-[#1e1e1e]/95 backdrop-blur-sm p-4 rounded-lg text-gray-300 font-mono text-[11px] shadow-2xl border border-gray-700 w-auto min-w-[260px] group">
              <div className="flex items-center justify-between mb-3 border-b border-gray-700 pb-2">
                <div className="flex gap-1.5">
                  <div className="w-2.5 h-2.5 rounded-full bg-[#ff90b3]" />
              ...
              <div className="space-y-1 font-medium leading-relaxed whitespace-nowrap">
                <p>
                  ...
                  <span className="text-[#e06c75]">manifesto</span> = {'{'}
                </p>
                <p className="pl-4">
                  <span className="text-[#d19a66]">vibe</span>:{' '}
                  <span className="text-[#98c379]">
                    "Thoughtful engineering, good taste"
                  </span>
                  ,
                </p>
                <p className="pl-4">
                  <span className="text-[#d19a66]">goal</span>:{' '}
                  <span className="text-[#98c379]">"2026 Full-Time"</span>,
                </p>
                <p className="pl-4">
                  <span className="text-[#d19a66]">fuel</span>: [
                  <span className="text-[#98c379]">"Matcha"</span>,{' '}
                  <span className="text-[#98c379]">"Code"</span>],
                </p>
                <p className="pl-4">
                  <span className="text-[#d19a66]">mood</span>:{' '}
                  <span className="text-[#98c379]">"Grateful"</span>
                </p>
                <p>{'};'}</p>
              </div>
            </div>
                ...
                <div className="flex bg-white dark:bg-[#1a1a1a] rounded-xl shadow-2xl overflow-hidden relative border-0">
                  <div className="flex-1 p-5 relative bg-gradient-to-br from-[#6366f1] via-[#8b5cf6] to-[#ec4899] text-white z-10">
                    <div className="flex justify-between items-start mb-3 relative">
                      <span className="inline-block px-2 py-0.5 bg-white/20 backdrop-blur-md text-white text-[9px] font-bold tracking-widest uppercase rounded-sm border border-white/30">
                        Student Access
                      </span>
                    ...
                    <div className="flex gap-4 text-[10px] opacity-90 font-mono text-white">
                      <div className="flex flex-col">
                        <span className="text-[8px] uppercase text-indigo-200 font-bold mb-0.5">
                          Date
                        </span>
                      ...
                      <div className="flex flex-col">
                        ...
                        <span className="font-bold text-sm flex items-center gap-1 whitespace-nowrap">
                  ...
                  <div className="w-14 relative bg-white dark:bg-gray-800 flex flex-col items-center justify-between py-3 border-l-2 border-dashed border-gray-300 dark:border-gray-600/50">
                    <span className="font-mono text-[9px] font-bold text-gray-400 rotate-90 whitespace-nowrap mt-6">
                      NO. 84921
                    </span>
                    <div
                      className="w-6 h-20 bg-gray-800 dark:bg-gray-400 opacity-70 my-2 mix-blend-multiply dark:mix-blend-normal"
                      style={{
                        maskImage:
                          'repeating-linear-gradient(to bottom, black, black 2px, transparent 2px, transparent 5px)',
                      }}
                    />
                    <span className="font-mono text-[9px] font-bold text-gray-400 rotate-90 mb-4">
                      ADMIT ONE
                    </span>
                  </div>
                </div>
